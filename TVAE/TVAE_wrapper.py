...
class TVAE(nn.Module):
    def __init__(self, feature_dim, continuous_dim, binary_dim, outcome_dist="normal", latent_dim_o=20,  device='cpu',
        ...
        self.config = dict(feature_dim=feature_dim, latent_dim_o=latent_dim_o, latent_dim_c=latent_dim_c,
                           ...
                           binary_dim=binary_dim, num_samples=num_samples)
    ...
    @torch.no_grad()
    def preds(self, x, ym, ys, num_samples=None):
